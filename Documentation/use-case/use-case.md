...
| 2 | Система | Проверяет наличие сети, если ее нет, уведомляет пользователя о невозможности синхронизации, если есть, то проверяется версию данных на сервере, если она совпадает с локальной, то загружает на сервер свои данные. Если версии локальная и серверная версии отличаются, то уведомляет пользователя об этом и просит выбрать, хочет ли он загрузить свои данные на сервер, или выгрузить данные с него. |
