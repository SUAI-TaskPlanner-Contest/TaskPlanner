...
| 4.2.2 | Система | Если данные приняты, то просит Пользователя придумать и ввести PIN-код, предупрежая, незабывать PIN-код. |
...
| 5.2.2 | Система | Если PIN-код введен неверно, то открывает окно "Предупреждение" с просьбой Пользователю ввести PIN-код еще раз, возвращаясь к шагу 4 данного сценария. |
